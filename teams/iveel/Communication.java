...
public class Communication {
    ...
    private static Map<String, Integer> channelTable; //name of channel, channel #
     ...
     * 
     * @param rc Robotcontroller from which new channel is requested
     * @param channelName 
     * @param value the value to be broadcasted
     * @return false if there is another channel under the same name. Otherwise, channel would be created and returns true.
     * @throws GameActionException
     */
    public boolean createChannel(RobotController rc,String channelName, int value) throws GameActionException{
     ...
     * Broadcasts value.
     * @param rc
     * @param channelName where the value to be broadcasted.
     * @param value 
     * @throws GameActionException
     */
    public static void broadcastValue(RobotController rc, String channelName, int value) throws GameActionException{
     ...
     * @throws GameActionException
     */
    public static void broadcastIncrementValue(RobotController rc, String channelName, int value) throws GameActionException{
        assert (channelTable.containsKey(channelName));
        int channelNum = channelTable.get(channelName);
